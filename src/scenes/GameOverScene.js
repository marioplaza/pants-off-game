export class GameOverScene extends Phaser.Scene {
    ...
    openSpotify() {
        ...
        if (isIOS) {
            console.log('GameOverScene: iOS detectado - usando detección mejorada');
            ...
            const handleVisibilityChange = () => {
                if (document.hidden && !fallbackTriggered) {
                    appOpened = true;
                    console.log('GameOverScene: App abierta, cancelando fallback');
                }
            };
            ...
            setTimeout(() => {
                ...
                if (!appOpened && !fallbackTriggered) {
                    ...
                    console.log('GameOverScene: App no detectada, abriendo web');
